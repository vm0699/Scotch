...
| Document | Purpose |
|---|---|
| [HANDOFF.md](HANDOFF.md) | **Next-session handoff** (state, design intent, gotchas) |
| [product/implementation-plan-phases-15-20.md](product/implementation-plan-phases-15-20.md) | Detailed stage-by-stage build plan for Phases 15–20 |
...
| [product/roadmap.md](product/roadmap.md) | Phases 0–20 staged roadmap with live status tracking |
| `integrations/` | Per-tool workflow guides (SketchUp, Revit, Rhino, Blender, rendering, sheets) — added as phases complete |

## Current Status

- **Phase 0 — Product Understanding & Plan Lock: COMPLETE**
- **Phase 1 — Local Working Skeleton MVP: COMPLETE**
- **Phase 2 — CADAM-Like UI Shell MVP: COMPLETE**
